...
class DualGpsCompass(Node):
    ...
    def heading_process_timer_callback(self):
        ...
        self.get_logger().info(f'Adjusted Heading Yaw Angle: {heading_yaw}')
        ...
        # Set covariance
        covariance = [0.0] * 36
        covariance[35] = 0.0004  # Variance in yaw (adjust based on your confidence)
        dual_gps_heading.pose.covariance = covariance
